...
documents = []
ignore_words = ['?', '!']
data_file = open(os.getcwd()+"\static\intents.json").read()
...
intents = json.loads(open(os.getcwd()+"\static"+"\\intents.json").read())
words = pickle.load(open(os.getcwd()+"\static"+'\\words.pkl','rb'))
classes = pickle.load(open(os.getcwd()+"\static"+'\\classes.pkl','rb'))
...
if __name__ == '__main__':
    start_chat("Automobile manufacturing company")